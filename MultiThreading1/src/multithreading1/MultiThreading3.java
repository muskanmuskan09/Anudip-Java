 ...
 */
// Question : write a programe by using Thread1 to print 1 to 20 and  
//Thread2 to print 21 to 60 and main thread using 61 to 80 
//set name of these thread and get name in their run method also  
